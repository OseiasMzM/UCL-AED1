...
class Estoque {
    ...
    public void mostraTabela(){
        ...
        Console.WriteLine($"ID: {i} | {descricao[i]}\nQuantidade: {Quantidade[i]}\nPreço: R$ {preco[i]}");
        Console.WriteLine("-------------------------------------");
        }
...
class Carrinho {
    ...
    List<int> carrinhoProd = new List<int>{};
    List<int> carrinhoQuantidade = new List<int>{};

    public void SetCarrinhoProd(int crr) {
        carrinhoProd.Add(crr);
    }
    public void SetCarrinhoQuanti(int crrQant) {
        carrinhoQuantidade.Add(crrQant);
    }

    public List<int> GetCarrinhoProd() {
        return carrinhoProd;
    }
